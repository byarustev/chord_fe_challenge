...
export default function SearchFilters({ genres, ratings, languages, searchKeyword, keyword, searchYear, year }) {
  return (
    <FiltersWrapper>
      ...
      <SearchFiltersCont>
        ...
        <ExpandableFilter title="Select genre (s)" itemsList={genres} />
        <ExpandableFilter title="Select min. vote" itemsList={ratings} />
        <ExpandableFilter title="Select Language" itemsList={languages} />
      </SearchFiltersCont>
    </FiltersWrapper>
  );
}
